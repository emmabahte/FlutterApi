        ...
        child:new Scaffold(
          ...
          bottomNavigationBar: BottomNavigationBar(
            ...
            items:<BottomNavigationBarItem>[
              ...
              new BottomNavigationBarItem(icon:new Icon(Icons.receipt,),title: new Text('Send Report')),
            ]
            ,onTap: changePage
            ...
            child: new DecoratedBox(
                child:new  ListView(
                  ...
                  children: <Widget>[
                    ...
                    new ListTile(
                      title: new Text('Reports',style: new TextStyle(color: Colors.white),),
                      trailing: new Icon(Icons.receipt,color: Colors.white,),
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>PageReports()));
                      },
                    ),
                    new ListTile(
